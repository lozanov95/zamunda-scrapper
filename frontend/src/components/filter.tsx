...
export function FilterSection({ domain, setFilterParams, hidden }: { setFilterParams: React.Dispatch<SetStateAction<string>>, domain: string, hidden: boolean }) {
    ...
    return (
        <div className={`flex flex-col font-semibold text-gray-200 items-center gap-2 rounded-lg w-[100%] lg:w-max ${hidden && 'hidden'}`}>
            ...
            <div className="flex gap-3 border-2 shadow-md bg-gradient-to-r from-cyan-700 to-cyan-900 border-cyan-950 shadow-cyan-800 px-6 py-4 rounded-lg w-[100%] justify-center">
            ...
            <div className="flex flex-col gap-3 shadow-md border-2 bg-gradient-to-r from-cyan-700 to-cyan-900  border-cyan-950 shadow-cyan-800 px-6 py-4 rounded-lg w-[100%] justify-center">
